...
RSpec.describe JobScraper do
  describe "#scrape" do
    it "deduplicates results by title+company_name and respects number_of_jobs target" do
      scraper = described_class.new(job_title: "Ruby", board_relevance: [], number_of_jobs: 2)
    ...
    it "stops when jobs_results is nil" do
      scraper = described_class.new(job_title: "Ruby", board_relevance: [], number_of_jobs: 10)
