...
RSpec.describe JobPost, type: :model do
  describe ".filtered" do
    ...
    it "filters by pay_range and experience_range" do
      ...
      results = JobPost.filtered({ pay_range: "100000_200000", experience_range: "5_8" })
